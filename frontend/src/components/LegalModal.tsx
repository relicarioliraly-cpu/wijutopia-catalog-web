...
export default function LegalModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-wiju-ink/86 px-4 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="legal-modal-title">
      <section className="max-w-2xl rounded-[2rem] border border-wiju-moonGold/60 bg-wiju-cardLight p-7 shadow-neon dark:bg-wiju-doorPurple">
        <p className="text-sm font-black uppercase tracking-[0.25em] text-wiju-signMagenta dark:text-wiju-moonGold">Aviso académico obligatorio</p>
        ...
        <button type="button" onClick={closeModal} data-sound="success" className="mt-6 w-full rounded-2xl bg-wiju-signMagenta px-5 py-3 font-black text-white shadow-neon transition hover:-translate-y-0.5 dark:bg-wiju-moonGold dark:text-wiju-ink">
